...
if __name__ == "__main__":
    ...
    f = open(os.path.join('..', folder_selected, filename + '{:03}'.format(file_num) + '.txt'),
             'w')  # Opens the first of the
    ...
    average_interval = deque(maxlen=4)  # Last 10 interval lengths, used to find the running average
    ...
    def write_signal(sig_file, datetime, sig, ecg, argmax):
