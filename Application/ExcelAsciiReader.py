...
ascii_file = open(os.path.join('..','ECG_Data', 'T21_transition example2_600s.ascii'),'r')
ecg2 = open(os.path.join('..', 'Training', 'ecg2.txt'), 'w')
sig2 = open(os.path.join('..', 'Training', 'sig2.txt'), 'w')
